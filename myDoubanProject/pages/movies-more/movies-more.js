Page({
  ...
  scroll() {
    ...
    switch(this.data.params_id){
      case '正在上映的电影-北京':
        nextUrl = `https://api.douban.com/v2/movie/in_theaters?start={curStart}&count=20`
        break;
      case '即将上映的电影':
        nextUrl = 'https://api.douban.com/v2/movie/coming_soon?start={curStart}&count=20'
        break;
      case '豆瓣电影Top250':
        nextUrl = 'https://api.douban.com/v2/movie/top250?start={curStart}&count=20'
        break;
      default:
        console.log('default')
        break;
